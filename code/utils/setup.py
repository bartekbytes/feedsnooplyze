...
class PersistenceLayerSetup:
    ...
    def execute_setup(self) -> bool:
        ...
        if self.persistence_engine == PersistenceEngineType.DUCK_DB:
            # add try here
            ...
            ddbpe = DuckDbPersistenceEngine(database="../persistence/viz.duckdb") # TODO: this is hardcoded, make it available from the Config file
